      ...
      <div class="develop-infomation-container-top">
        <div class="left">
          ...
          <div class="develop-container-bottom">
            ...
            <div class="desc">
              <span
                >三库建设是为了更好的实现奇伟研产中心核心竞争力，即四大标准：技术标准、制造标准、品牌标准和服务标准的实现。</span
              >
              <br />
              <div style="height: 10px"></div>
              <span>
                三库建设是公司科研和工作人员进行技术研究、产品开发、业务拓展和学习提升的理想场所三库建设是为奇伟客户提供增值服务、为同行提供优质供应链的化妆品行业信息沙龙。</span
              >
              <br />
              <div style="height: 10px"></div>
              <span>
                作用是研发中心、市场部、业务部在市场竞争中快速反应，统一想法、明确方法、落实做法，优先把握市场机会，各项工作化被动为主动。</span
              >
            </div>
            ...
            <div class="right">
              <div class="right-top">
                ...
                <div class="right-item">
                  ...
                  <div class="kl-dec">
                    <span>提案库</span>
                    <span>专线类提案库，趋势类提案库，客户类提案库，外来提案库</span>
                  </div>
                </div>
              </div>
