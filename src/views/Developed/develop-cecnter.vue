<template>
  <div class="develop-center">
    <div class="develop-center-base-container">
      ...
      <div class="develop-container-bottom">
        <div class="develop-container-bottom-left">
          <div class="develop-cotainer-bottom-left-item">
            ...
            <div class="desc">
              <span>以综合性测评为导向</span>
              <span>化妆品研发以严格遵循安全性、功能性、稳定性、法规合规性及消费者需求为导向，通过多项测试确保产品全面满足市场需求。</span>
            </div>
          </div>
          <div class="develop-cotainer-bottom-left-item">
            ...
            <div class="desc">
              <span>专业性研发团队</span>
              <span>拥有深厚的专业知识与广泛的实践经验，更具备敏锐的市场洞察力，能够精准捕捉潮流趋势与消费者需求。</span>
            </div>
          </div>
        </div>
        <div class="develop-container-bottom-center">
          <div class="develop-cotainer-bottom-center-item">
            ...
            <div class="desc">
              <span>完善实验室支持</span>
              <span>公司拥有完善的物理、化学和生物实验室设施，为研发创新和产品制程提供了全方位、强有力的技术支持。</span>
            </div>
          </div>
          ...
          <div class="develop-cotainer-bottom-center-item">
            ...
            <div class="desc">
              <span>质量严格控</span>
              <span>我们秉持质量至上的原则，从源头精选优质原料，历经多轮精细筛选与全面评测，每一步都倾注匠心。确保产品妆效的卓越，为客户带来卓越体验。</span>
            </div>
          </div>
        </div>
        <div class="develop-container-bottom-right">
          <div class="develop-cotainer-bottom-right-item">
            ...
            <div class="desc">
              <span>知识产权保护体系</span>
              <span>奇伟始终将科技创新视为公司发展的核心驱动力，并建立了完善的知识产权保护体系，目前拥40+核心专利证书。</span>
            </div>
          </div>
        </div>
      </div>
