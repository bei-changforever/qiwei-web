<template>
    <div class="business-chain">
        <div class="business-chain-base-container">
            <div class="business-chain-left">
                <div class="T-left">
                    <div class="topic">
                        <div class="block"></div>
